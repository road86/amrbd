...
<html>
    ...
    <head>
         <title>List of Pathogen</title>
    </head>
    
    <body>
        <!-- Define header and footer blocks before your content -->
        <header>
          <h2 style="margin-bottom: 5px">List of Pathogen on Culture Sensitivity Testing Application</h2>
          <hr>
        </header>
        ...
        <main>
            ...
            <tbody>
              @php $sl=0; @endphp
              @foreach($pathogen as $row=>$data)
              <tr>
                <td style="text-align: center"><b>{{++$sl}}</b></td>
                <td><b>{{$data->pathogen_name}}<b></td> 
              </tr>
              @endforeach
            </tbody>         
          </table>
