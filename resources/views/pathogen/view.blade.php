    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
          ...
          @endif
           ...
           <h3 style="text-align: center; color:#5b92e5">List of Pathogens</h3>
          ...
          <table class="table" width="100%">
            <tr>
              <th scope="col" width="77.8%"><a class="btn btn-primary" href="{{ url('/') }}/pathogen/create">Add New Pathogen Name</a></th> 
              <th scope="col"> <a class="btn btn-primary" href="{{ url('/') }}/pathogen/excel">Export Excel</a></th> 
          ...
          <table class="table" id="tableview">
            ...
            <tbody>
              ...
              @foreach($pathogen as $data)
              <tr>
                <th scope="row">{{ $count }}</th>
                <td>{{ $data->pathogen_name }}</td>
