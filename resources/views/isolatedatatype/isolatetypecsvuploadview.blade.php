        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 style="text-align: center;color:#5b92e5">Upload a CSV/XLS file having data in [S|I|R] outcome</h3>
                    <hr style="border: 5px solid green;border-radius: 5px"> 
                </div>

                <div class="card-body">
					
					<form action="{{ url('/') }}/isolatedatatype/uploadCSVFile" method="POST" enctype="multipart/form-data">  
