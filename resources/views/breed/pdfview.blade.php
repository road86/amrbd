...
<html>
    ...
    <head>
         <title>List of Breed</title>
    </head>
    
    <body>
        <!-- Define header and footer blocks before your content -->
        <header>
          <h2 style="margin-bottom: 5px">List of Breed on Culture Sensitivity Testing Application</h2>
          <hr>
        </header>
        ...
        <main>
            ...
            <tbody>
              @php $sl=0; @endphp
              @foreach($breed as $row=>$data)
              <tr>
                <td style="text-align: center"><b>{{++$sl}}</b></td>
                <td><b>{{$data->species->species_name}}<b></td> 
