        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                   <h3 style="text-align: center;color:#5b92e5">Generate Report for Individual Isolate [ZDIS] Data</h3>
                   <hr style="border: 5px solid green;border-radius: 5px"> 
                 </div>

                <div class="card-body">
                     <form action="{{ url('/') }}/report/indizdisreportcalculation" method="POST">
                    {{ csrf_field() }}
