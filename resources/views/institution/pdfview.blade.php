...
<html>
    ...
    <body>
        ...
        <header>
          <h2 style="margin-bottom: 5px">List of Institutions on Culture Sensitivity Testing Application</h2>
          <hr>
        </header>
        ...
        <main>
            ...
            <tbody>
              @php $sl=0; @endphp
              @foreach($institution as $row=>$data)
              <tr>
                <td style="text-align: center"><b>{{++$sl}}</b></td>
                <td><b>{{$data->institution_name}}<b></td> 
              </tr>
              @endforeach
            </tbody>         
          </table>
