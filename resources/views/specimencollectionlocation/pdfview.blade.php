...
<html>
    ...
    <head>
         <title>List of Sampling Location</title>
    </head>
    
    <body>
        <!-- Define header and footer blocks before your content -->
        <header>
          <h2 style="margin-bottom: 5px">List of Sampling Location on Culture Sensitivity Testing Application</h2>
          <hr>
        </header>
        ...
        <main>
            ...
            <tbody>
              @php $sl=0; @endphp
              @foreach($samplinglocname as $row=>$data)
              <tr>
                <td style="text-align: center"><b>{{++$sl}}</b></td>
                <td><b>{{$data->specimen_location_name}}<b></td> 
              </tr>
              @endforeach
            </tbody>         
          </table>
