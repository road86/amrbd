...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h4>Fill the Summarize Isolate Percentage Test Data</h4></div>

                <div class="card-body">

        <form action="{{ url('/') }}/summarizeipersampletest/store" method="POST">
           {{ csrf_field() }}
        ...
        <table id=tableview width="100%">
            <thead>
              <tr>
                ...
                <th scope="col">Summarize Test Result (%)</th>
               </tr>
            </thead>
            ...
            <tbody>
             @foreach($antibiotic as $row=>$val)
               ...
               <td><label><input type="checkbox" value="{{$val->antibiotic_id}}" 
                    ...
                    <td> <label> <input type="number" class="form-control" value="{{$val->test_result_percent}}"  name="test_result_percent[{{$val->antibiotic_id}}]"> </label></td>
