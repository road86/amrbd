...
<html>
    ...
    <head>
         <title>List of Sensitivity Type</title>
    </head>
    
    <body>
        <!-- Define header and footer blocks before your content -->
        <header>
          <h2 style="margin-bottom: 5px">List of Sensitivity Type on Culture Sensitivity Testing Application</h2>
          <hr>
        </header>
            ...
            <table class="table" id="pdftableview" width="100%">
             <thead>
              <tr>
                ...
                <th scope="col">Sensitivity Type</th>   
              </tr>
             </thead>
            
            <tbody>
              @php $sl=0; @endphp
              @foreach($testsensitivitytype as $row=>$data)
              <tr>
