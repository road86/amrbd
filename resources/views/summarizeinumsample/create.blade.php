        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 style="text-align: center;color:#5b92e5">Insert Summarized Isolate Numeric Sample Data</h3>
                    <hr style="border: 5px solid green;border-radius: 5px"> 
                </div>

                <div class="card-body">

                  <form action="{{ url('/') }}/summarizeinumsample/store" method="POST">
                    {{ csrf_field() }}
               ...
               <table id=tableview width="100%">
                ...
                {{--   Commented # of isolates and sensitivity pattern 
                      <tr>
                         <td>
                        ...
                        <td>
                          <label for="sensitivity_pattern_type"><h4>Select Sensitivity Pattern Type</h4>
